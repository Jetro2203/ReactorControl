...
function draw_menu_m()
    ...
    elseif config.page.mon == "battery" then
        screen.drawTextM(2,3,"CHARGE: "..BatPercent.." %",colors.blue,colors.black)
        screen.drawTextM(2,4,"DELTA: ",colors.blue,colors.black)
        screen.drawTextM(9,4,(math.floor(battery[1].getAverageChangePerTick()*100)/100).." RF/t",colors.blue,(battery[1].getAverageChangePerTick() > 0 and colors.lime) or (battery[1].getAverageChangePerTick() < 0 and colors.red) or (battery[1].getAverageChangePerTick() == 0 and colors.black))
        screen.drawTextM(2,5,"STATE: "..((battery[1].getAverageChangePerTick() > 0 and "Charging") or (battery[1].getAverageChangePerTick() < 0 and "Discharging") or (battery[1].getAverageChangePerTick() == 0 and "Stable")),colors.blue,colors.black)
        screen.drawTextM(2,6,"Input: "..(math.floor(battery[1].getAverageInputPerTick()*100)/100).." RF/t")
        screen.drawTextM(2,7,"Output: "..(math.floor(battery[1].getAverageOutputPerTick()*100)/100).." RF/t")
    end
end
